...
import { findMatchingRoute, findMatchingPaymentRequirements } from "@paylatch/x402/shared";
import { getPaywallHtml } from "@paylatch/x402/paywall";
import {
  FacilitatorConfig,
  Network,
...
// Mock dependencies
vi.mock("@paylatch/x402/verify", () => ({
  useFacilitator: vi.fn(),
}));

vi.mock("@paylatch/x402/paywall", () => ({
  getPaywallHtml: vi.fn(),
}));

vi.mock("@paylatch/x402/shared", async importOriginal => {
